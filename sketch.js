var helicopterIMG, helicopterSprite, packageSprite,packageIMG,fenceIMG,fenceIMGflip,fence1,fence2,boxx1,box2,box3;
...
function setup() {
	...
	box1 = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:false} );
	 World.add(world, box1);

	box2 = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:false} );
	 World.add(world, box2);

	box3 = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:false} );
